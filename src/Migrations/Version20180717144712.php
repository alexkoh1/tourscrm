 ...
 */
final class Version20180717144712 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, tail INTEGER DEFAULT NULL, vk VARCHAR(30) DEFAULT NULL COLLATE BINARY, telegram VARCHAR(30) DEFAULT NULL COLLATE BINARY, phone VARCHAR(18) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, tail, phone, vk, telegram FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, tail INTEGER DEFAULT NULL, vk VARCHAR(30) DEFAULT NULL, telegram VARCHAR(30) DEFAULT NULL, phone VARCHAR(10) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO client (id, name, tail, phone, vk, telegram) SELECT id, name, tail, phone, vk, telegram FROM __temp__client');
        $this->addSql('DROP TABLE __temp__client');
        $this->addSql('DROP INDEX IDX_BB4D3A0B19EB6921');
        $this->addSql('DROP INDEX IDX_BB4D3A0B15ED8D43');

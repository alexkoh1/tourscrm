 ...
 */
final class Version20181115160911 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, tail, vk, telegram, phone, is_lead, vk_id, bday FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, tail INTEGER DEFAULT NULL, vk VARCHAR(30) DEFAULT NULL COLLATE BINARY, telegram VARCHAR(30) DEFAULT NULL COLLATE BINARY, is_lead BOOLEAN DEFAULT NULL, vk_id VARCHAR(11) DEFAULT NULL COLLATE BINARY, bday DATE DEFAULT NULL, phone VARCHAR(18) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO client (id, name, tail, vk, telegram, phone, is_lead, vk_id, bday) SELECT id, name, tail, vk, telegram, phone, is_lead, vk_id, bday FROM __temp__client');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__expense AS SELECT id, type_id, tour_id, guide_id, sum FROM expense');
        $this->addSql('DROP TABLE expense');
        $this->addSql('CREATE TABLE expense (id INTEGER NOT NULL, type_id INTEGER NOT NULL, tour_id INTEGER NOT NULL, guide_id INTEGER DEFAULT NULL, sum INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_2D3A8DA6C54C8C93 FOREIGN KEY (type_id) REFERENCES expense_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2D3A8DA615ED8D43 FOREIGN KEY (tour_id) REFERENCES tour (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2D3A8DA6D7ED1D4B FOREIGN KEY (guide_id) REFERENCES guide (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO expense (id, type_id, tour_id, guide_id, sum) SELECT id, type_id, tour_id, guide_id, sum FROM __temp__expense');
        $this->addSql('DROP TABLE __temp__expense');
        $this->addSql('CREATE INDEX IDX_2D3A8DA6D7ED1D4B ON expense (guide_id)');
        ...
        $this->addSql('CREATE TABLE client_tour (client_id INTEGER NOT NULL, tour_id INTEGER NOT NULL, PRIMARY KEY(tour_id, client_id), CONSTRAINT FK_BB4D3A0B15ED8D43 FOREIGN KEY (tour_id) REFERENCES tour (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BB4D3A0B19EB6921 FOREIGN KEY (client_id) REFERENCES client (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, tail, phone, vk, telegram, is_lead, vk_id, bday FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, tail INTEGER DEFAULT NULL, vk VARCHAR(30) DEFAULT NULL, telegram VARCHAR(30) DEFAULT NULL, is_lead BOOLEAN DEFAULT NULL, vk_id VARCHAR(11) DEFAULT NULL, bday DATE DEFAULT NULL, phone VARCHAR(18) NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO client (id, name, tail, phone, vk, telegram, is_lead, vk_id, bday) SELECT id, name, tail, phone, vk, telegram, is_lead, vk_id, bday FROM __temp__client');
        $this->addSql('DROP TABLE __temp__client');
        $this->addSql('DROP INDEX IDX_BB4D3A0B15ED8D43');
        $this->addSql('DROP INDEX IDX_BB4D3A0B19EB6921');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__expense AS SELECT id, type_id, tour_id, guide_id, sum FROM expense');
        $this->addSql('DROP TABLE expense');
        $this->addSql('CREATE TABLE expense (id INTEGER NOT NULL, type_id INTEGER NOT NULL, tour_id INTEGER NOT NULL, guide_id INTEGER DEFAULT NULL, sum INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO expense (id, type_id, tour_id, guide_id, sum) SELECT id, type_id, tour_id, guide_id, sum FROM __temp__expense');
        $this->addSql('DROP TABLE __temp__expense');
        $this->addSql('CREATE INDEX IDX_2D3A8DA6C54C8C93 ON expense (type_id)');
        $this->addSql('CREATE INDEX IDX_2D3A8DA615ED8D43 ON expense (tour_id)');

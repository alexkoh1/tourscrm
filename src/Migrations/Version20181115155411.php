 ...
 */
final class Version20181115155411 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD COLUMN bday DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, tail, phone, vk, telegram, is_lead, vk_id FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, tail INTEGER DEFAULT NULL, phone VARCHAR(18) NOT NULL, vk VARCHAR(30) DEFAULT NULL, telegram VARCHAR(30) DEFAULT NULL, is_lead BOOLEAN DEFAULT NULL, vk_id VARCHAR(11) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO client (id, name, tail, phone, vk, telegram, is_lead, vk_id) SELECT id, name, tail, phone, vk, telegram, is_lead, vk_id FROM __temp__client');
